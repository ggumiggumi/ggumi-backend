...
public class HistoryController {
	...
	@GetMapping("")
	public ResponseDto<MbtiHistoryPageDto> getHistory(@RequestParam("childId") String childId) {
		return ResponseUtil.SUCCESS("자녀의 MBTI history 정보를 가져오는 것을 성공하였습니다.",
			historyService.getChildInfoMbtiHistory(childId));
	}

	@GetMapping("my-child-mbti")
	public ResponseDto<MyChildMBTITypeDto> getChildMbti(@RequestParam("childId") String childId) {
